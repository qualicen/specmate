...
public class UserMetricService implements IUserMetricsService {
	...
	public void start() throws SpecmateException {
		...
		this.specmate_current_day = metricsService.createGauge("login_counter_current_day",
				"Number of users logged in at the current day");
		this.specmate_current_week = metricsService.createGauge("login_counter_current_week",
				"Number of users logged in at the current week");
		this.specmate_current_month = metricsService.createGauge("login_counter_current_month",
				"Number of users logged in at the current month");
		this.specmate_current_year = metricsService.createGauge("login_counter_current_year",
				"Number of users logged in at the current year");
		createSchedulers();
	...
	private void createSchedulers() {
		try {
			...
			Scheduler schedulerWeek = new Scheduler(logger);
			...
			Scheduler schedulerMonth = new Scheduler(logger);
			...
			Scheduler schedulerYear = new Scheduler(logger);
	 ...
	 * @param userName
	 * @param difference
	 * @return Returns if the user with the userName has been logged in in the
	...
	/**
	 * Use the session view to identify how many session existed before startup of
	 * system and set the counter correspondingly
	 */
