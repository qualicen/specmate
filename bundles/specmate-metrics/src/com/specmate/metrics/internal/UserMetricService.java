...
public class UserMetricService implements IUserMetricsService {
	...
	public void start() throws SpecmateException {
		...
		specmate_current_day = metricsService.createGauge("login_counter_current_day",
				"Number of users logged in at the current day");
		specmate_current_week = metricsService.createGauge("login_counter_current_week",
				"Number of users logged in at the current week");
		specmate_current_month = metricsService.createGauge("login_counter_current_month",
				"Number of users logged in at the current month");
		specmate_current_year = metricsService.createGauge("login_counter_current_year",
