...
export class EditorStyle {
    ...
    private static readonly BASE_CEG_NODE_STYLE_STR = 'shape=rectangle;autosize=1;whiteSpace=wrap';
    ...
    private static initStyles() {
        ...
        EditorStyle.EMPTY_TEXT_STYLE[mx.mxConstants.STYLE_STROKECOLOR] = '#666666';
    }
